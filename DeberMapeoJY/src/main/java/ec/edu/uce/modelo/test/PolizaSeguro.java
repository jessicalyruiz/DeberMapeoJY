package ec.edu.uce.modelo.test;
...
public class PolizaSeguro {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_pose")
	@SequenceGenerator(sequenceName = "seq_pose", name = "seq_pose",allocationSize = 1)
	@Column(name = "pose_id")
	private Integer id;
